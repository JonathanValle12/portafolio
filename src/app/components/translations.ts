...
export const TRANSLATIONS_EN = {
    ...
    textBioAboutMe: "I'm Jonathan, a web and mobile development enthusiast from Barcelona. At 21 years old and with a double degree in progress, he enjoys creating innovative digital solutions. My passion is combining creativity and technology to offer exceptional experiences. Explore my portfolio and discover my journey in app development.",
