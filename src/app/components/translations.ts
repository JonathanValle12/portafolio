...
export const TRANSLATIONS_ES = {
    ...
    buscaminas_description: 'El buscaminas que desarrollé es una versión clásica del juego de estrategia. Los jugadores deben descubrir casillas sin minas evitando las explosiones, utilizando pistas numéricas para guiarse a través del campo de juego',
...
export const TRANSLATIONS_EN = {
    ...
    buscaminas_description: "The Minesweeper I developed is a classic version of the strategic game. Players must uncover squares without mines, avoiding explosions, and using numeric clues to navigate the game board",
